...
export class UI {
    /**
     * Ejemplo de uso:  Se coloca el querySelector para el botón de suma 
     * y se le añade un evento de click, esta función recibe un callback 
     * que se ejecutará cuando el botón sea clickeado.
